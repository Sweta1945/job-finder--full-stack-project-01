  ...
  const handleSubmitJobDetails = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://backend-server-1yct.onrender.com/job/job-form",
        {
          method: "POST",
          headers: {
    ...
    <div className="addJobForm">
      <div className="form-leftSide">
        <form className="formAddJob">
          ...
          <label className="remoteOrOffice">
            {" "}
            Remote/office
            <select
              type="text"
          ...
          <label className="label_jobDescription">
            {" "}
            Job Description
            <input
              type="text"
          ...
          <div className="buttonDiv">
            ...
            <button className="addJobB" onClick={handleSubmitJobDetails}>
              + Add Job
            </button>
          </div>
        </form>
      ...
      <div className="form-rightSide">
        <img src={formImg} className="JobFormImg"></img>
